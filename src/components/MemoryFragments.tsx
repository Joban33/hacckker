    ...
    >
      ...
      <div className="w-[80px] h-full border-r border-white/5 flex flex-col items-center py-8 z-20 shrink-0 bg-black/20 backdrop-blur-sm">
        ...
        <div className="flex flex-col items-center space-y-2 mb-12">
          <div className="text-[#d4ff00] font-semibold text-lg leading-none">05</div>
            ...
            <div className="border border-white/10 p-6 relative">
              ...
              <div className="flex justify-between items-end mb-8">
                <div>
                  ...
                  <div className="text-2xl text-[#d4ff00] font-mono">12,847</div>
                </div>
        ...
        <div className="h-[140px] border-t border-white/5 flex px-8 shrink-0 bg-black/40 backdrop-blur-sm z-30">
          ...
          <div className="flex-1 border-r border-white/5 py-4 pr-6 relative overflow-hidden">
             ...
             <div className="flex items-end justify-between h-[60px] relative">
               {/* Realistic ECG Heartbeat animation */}
               <svg className="absolute top-0 left-0 w-[400%] h-full opacity-70" viewBox="0 0 400 40" preserveAspectRatio="none">
                 <g className="ecg-line" style={{ animation: 'slideLeft 2s linear infinite' }}>
                   {/* Repeated ECG pattern */}
                   <path d="M0,20 L40,20 L45,10 L50,35 L55,5 L60,25 L65,20 L100,20 L140,20 L145,10 L150,35 L155,5 L160,25 L165,20 L200,20 L240,20 L245,10 L250,35 L255,5 L260,25 L265,20 L300,20 L340,20 L345,10 L350,35 L355,5 L360,25 L365,20 L400,20" fill="none" stroke="#d4ff00" strokeWidth="1.5" style={{ filter: 'drop-shadow(0px 0px 4px #d4ff00)' }} />
                 </g>
               </svg>
               <div className="text-right z-10 ml-auto bg-black/40 p-2 backdrop-blur-sm rounded">
                 <div className="text-2xl text-[#d4ff00] font-mono leading-none">68%</div>
          ...
          <div className="flex-1 border-r border-white/5 py-4 px-6 relative">
             ...
             <div className="flex items-end gap-[2px] h-[40px] opacity-60">
                {Array.from({ length: 40 }).map((_, i) => (
                  <div 
                    key={i} 
                    className={`flex-1 bar-chart-bar origin-bottom ${i > 25 && i < 35 ? 'bg-red-500' : 'bg-white/30'}`} 
                    style={{ 
                      height: '100%',
                      animation: 'pulseHeight 0.2s ease-in-out infinite alternate',
          ...
          <div className="flex-1 border-r border-white/5 py-4 px-6 relative overflow-hidden flex items-center justify-center">
             ...
             <div className="w-full h-[60px] mt-4 relative">
               <svg className="w-full h-full opacity-60" viewBox="0 0 100 40" preserveAspectRatio="none">
                 <path className="wireframe-path" d="M0,20 L20,10 L40,30 L60,15 L80,25 L100,10" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="1" style={{ animation: 'floatPath 1s ease-in-out infinite alternate', animationDelay: '0s' }} />
                 <path className="wireframe-path" d="M0,25 L20,15 L40,35 L60,20 L80,30 L100,15" fill="none" stroke="rgba(255,255,255,0.4)" strokeWidth="1" style={{ animation: 'floatPath 1s ease-in-out infinite alternate', animationDelay: '0.2s' }} />
                 <path className="wireframe-path" d="M0,30 L20,20 L40,40 L60,25 L80,35 L100,20" fill="none" stroke="rgba(212,255,0,0.5)" strokeWidth="0.5" style={{ animation: 'floatPath 1s ease-in-out infinite alternate', animationDelay: '0.4s' }} />
               ...
               <div className="absolute top-1/2 left-1/2 w-2 h-2 bg-[#d4ff00] rounded-full shadow-[0_0_10px_#d4ff00] -translate-x-1/2 -translate-y-1/2" />
             </div>
          </div>
          ...
          <div className="flex-1 py-4 pl-6 relative">
             ...
             <div className="flex justify-between items-center">
               ...
               <div className="text-right">
                 <div className="text-2xl text-[#d4ff00] font-mono leading-none mb-1">42%</div>
