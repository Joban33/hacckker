  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-8 py-20 w-full h-full">
        ...
        {stage === 1 && (
          <div className="flex flex-col items-center justify-center text-red-500 font-mono w-[400px] max-w-full text-left space-y-4">
            <div className="text-[12px] tracking-[0.5em] mb-4">
        ...
        {stage === 2 && (
          <div className="transition-opacity duration-500 opacity-100 flex flex-col items-center justify-center w-full max-w-4xl mx-auto">
            ...
            <h1 
              className="font-mono font-bold text-5xl md:text-7xl leading-tight mb-10 tracking-[0.1em] text-red-500 uppercase relative inline-block text-center"
            ...
            {/* IP Address Box */}
            <div className="border border-red-500/30 bg-black/80 p-8 w-full max-w-[550px] relative mb-10 mx-auto">
              ...
              <div className="text-[10px] tracking-widest text-red-500/40 uppercase mb-6 flex justify-between">
              ...
              <div className="space-y-4 text-left font-mono">
                <div>
                  <span className="text-red-500/40 text-[10px] block mb-1">IP ADDRESS:</span>
                  <span className="text-2xl text-red-500 tracking-wider shadow-red-500/50 drop-shadow-md">
                    {ipData.ip || 'FETCHING...'}
                  </span>
                </div>
                <div>
                  <span className="text-red-500/40 text-[10px] block mb-1">GEO-COORDINATES:</span>
                  <span className="text-sm text-white/60 tracking-widest block mb-1">
                    LAT: {ipData.lat?.toFixed(4)} // LON: {ipData.lon?.toFixed(4)}
                  </span>
                  <span className="text-red-500/40 text-[10px] block mt-3 mb-1">PHYSICAL LOCATION:</span>
                  <span className="text-lg text-white/80 tracking-widest">
                    {ipData.city ? `${ipData.city}, ${ipData.region}, ${ipData.country}` : 'TRIANGULATING...'}
                  </span>
                </div>
                <div className="pt-4 border-t border-red-500/20">
                  <span className="text-red-500/40 text-[10px] block mb-1">SYSTEM STATUS:</span>
                  <span className="text-lg text-red-500 tracking-widest" style={{ animation: 'fastBlink 0.1s infinite' }}>
                    COMPROMISED
                  </span>
                </div>
              </div>
            ...
            <div className="text-[10px] tracking-[0.3em] text-white/40 uppercase leading-loose max-w-[500px] text-center">
